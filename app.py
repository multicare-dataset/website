    ...
    with st.container():
        ...
        st.markdown(
            ...
            <div style="text-align: center;">
                <img src="data:image/jpeg;base64,{convert_image_to_base64(image_path)}" alt="{image_caption}" style="width: 10%; border-radius: 8px;">
        ...
        if not images.empty:
            for idx in images.index:
                ...
                st.markdown(
                    f"""
                    <div style="text-align: center;">
                        <img src="data:image/jpeg;base64,{convert_image_to_base64(image_path)}" alt="{image_caption}" style="width: 20%; border-radius: 8px;">
                        <p><em>{image_caption}</em></p>
                    </div>
                    """,
                    unsafe_allow_html=True,
